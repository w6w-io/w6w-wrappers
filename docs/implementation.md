...
|---|---|---|---|---|---|---|
| `me` | `GET /me` | *(none — flat body)* | `Me` | `client.me()` | `client.me()` | `w6w me` |
...
| `workflows.run` | `POST /workflows/{id}/run` | *(none — flat body)* | `RunResult` | `client.workflows.run(id, opts?)` | `client.workflows.run(id, **opts)` | `w6w workflows run <id> [--wait]` |
